...
<section class="our-services">
	<div class="container">
		<div class="row">
		  	<div class="col-md-8 col-md-offset-2 text-center edustyle">
				...
				<div class="container demo">  
					<div class="panel-group " id="accordion" role="tablist" aria-multiselectable="true">
						<div class="panel panel-default">
					        <div class="panel-heading educationsection justify-content-center" role="tab" id="headingOne">
					            <h4 class="panel-title">
					                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false"aria-controls="collapseOne">
					                    <b><i class="more-less glyphicon glyphicon-plus"></i></b>
					                    <img src="books.png">Coaching Classes
					                </a>
					           	</h4>
					        </div>
					    ...
					    <div class="panel panel-default just">
					        <div class="panel-heading educationsection" role="tab" id="headingTwo">
					            <h4 class="panel-title">
					                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false"aria-controls="collapseTwo">
					                	<i class="more-less glyphicon glyphicon-plus"></i>
					                	<img src="graduation.png">Graduation
					                </a>
					            </h4>
					        </div>
					        ...
					        <div class="panel panel-default">
					            <div class="panel-heading educationsection" role="tab" id="headingThree">
					                <h4 class="panel-title">
					                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
					                        <i class="more-less glyphicon glyphicon-plus"></i>
					                         <img src="computer.png">Technical Courses
					                    </a>
					                </h4>
					            </div>
					        ...
					        <div class="panel panel-default">
					            <div class="panel-heading educationsection" role="tab" id="headingFour">
					                <h4 class="panel-title">
					                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
					                        <i class="more-less glyphicon glyphicon-plus"></i>
					                        <img src="teacher-pointing.png">English Certification Courses
					                    </a>
					                </h4>
					            </div>
					         ...
					         <div class="panel panel-default  just">
					            <div class="panel-heading educationsection" role="tab" id="headingFive">
					                <h4 class="panel-title">
					                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
					                        <i class="more-less glyphicon glyphicon-plus"></i>
					                        <img src="exam (1).png">Entrance Exams
					                    </a>
					                </h4>
					            </div>
